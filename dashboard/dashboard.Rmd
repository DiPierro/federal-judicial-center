...
file_fjc <- here::here("c01-own", "data-raw", "dashboard.rds")

# File with Census data
file_census <- here::here("c01-own", "data-raw", "cb_county_population_2000_2018.rds")
...
To make your own custom dashboard, visit the [Federal Judicial Center Dashboard project repository on GitHub](TKNEED LINKTK).

Disclaimers:

* This dashboard was created by Amy DiPierro in March 2020. It is not an official product of the Federal Judicial Center.
